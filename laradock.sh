...
TITLE="GRAFANA BUILDER SCRIPT"      # script name
...
CONTAINER_PRODUCTION="prometheus alertmanager nodeexporter cadvisor grafana pushgateway portainer caddy"
CONTAINER_DEVELOPMENT="prometheus alertmanager nodeexporter cadvisor grafana pushgateway caddy portainer"
